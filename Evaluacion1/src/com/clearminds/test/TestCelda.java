...
public class TestCelda {
	public static void main(String[] args) {
		...
		System.out.println("*************************************");
		// El nullpointerException salta en la linea 8, esto porque no se carga ningun producto por lo cual esta en null y al intentar acceder al metodo get
		// nos da esta excepcion.
	}
}
